...
| R6 preview refresh | Compiles, not measured | Channel-driven `Subscription::run`; `mpsc` bridge | Runtime test: refresh smoothness + send→render latency — not measured this session. |

...
| 3 — Box Tools | Planned | [`2026-07-14-box-tools-design.md`](2026-07-14-box-tools-design.md) (`1bdc539`) | [`2026-07-14-box-tools.md`](../plans/2026-07-14-box-tools.md) (`427da33`) | Complete six-task TDD plan committed on `feat/annotation-box-tools`; implementation has not started. Exact execution entry point is Task 1: record `In progress`, then add the additive `ShapeKind` boundary. | 2026-07-14 |

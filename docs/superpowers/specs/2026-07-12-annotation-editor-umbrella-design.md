...
| 3 — Box Tools | Complete | [`2026-07-14-box-tools-design.md`](2026-07-14-box-tools-design.md) (`1bdc539`) | [`2026-07-14-box-tools.md`](../plans/2026-07-14-box-tools.md) (`427da33`) | Landed in PR #92 (`d164524`). Automated verification 2026-07-14: `rtk cargo test` 540 passed / 3 pre-existing failures (stale `config.toml` in `result_workspace::tests`) / 3 ignored; fmt pass; clippy pre-existing `needless_range_loop` warnings in `raster.rs` only; 100-annotation long-image test covers all 7 types; shape output lifecycle tests pass. The complete native Linux/macOS Result Workspace runtime checklists (spec §13 groups 1-8) were not executed in the headless implementation environment; on 2026-07-14 the user explicitly accepted that documented runtime risk, approved Slice 3 as complete, and confirmed no further Slice 3 work is required. | 2026-07-14 |
| 4 — Freehand Tools | Complete | [`2026-07-14-freehand-tools-design.md`](2026-07-14-freehand-tools-design.md) (`3ab711f`) | [`2026-07-14-freehand-tools.md`](../plans/2026-07-14-freehand-tools.md) (`2676b58`) | Landed in PR #93 (`479576c`). Automated verification 2026-07-14: `rtk cargo test` 594 passed / 3 pre-existing failures (stale `config.toml` in `result_workspace::tests`) / 3 ignored; `rtk cargo fmt --check` PASS; `rtk cargo clippy --workspace --all-targets -- -D warnings` PASS; `rtk git diff --check` PASS; 100 mixed annotations on long-image 0.47s. PR #93 subsequently isolated workspace tests from the real `config.toml`. The complete native Linux/macOS Result Workspace runtime checklists were not executed in the headless implementation environment; on 2026-07-15 the user explicitly accepted that documented runtime risk and the bounded, output-safe lyon self-overlap live-preview deviation, approved Slice 4 as complete, and confirmed no further Slice 4 work is required. | 2026-07-15 |
| 5 — Pixelate Effect | Complete | [`2026-07-15-pixelate-effect-design.md`](2026-07-15-pixelate-effect-design.md) (`518064e`) | [`2026-07-15-pixelate-effect.md`](../plans/2026-07-15-pixelate-effect.md) (`1cf18b1`) | Landed in PR #94 (`10beaa1`). Automated verification 2026-07-15: `rtk cargo test` 2048 passed / 8 ignored; `rtk cargo fmt --check` PASS; `rtk cargo clippy --workspace --all-targets -- -D warnings` PASS; `rtk git diff --check` PASS; `rtk cargo check -p rollshot-app --features action-guide` PASS (0 errors, 3 warnings). The 100-annotation long-image fixture covers all 8 committed types including Pixelate. Security boundary tests confirm Pixelate is never secure; OCR masks exclude Pixelate; Copy/Save is independent of the preview cache. The complete native Linux/macOS Result Workspace runtime checklists (spec §16 groups 1-8) were not executed in the headless implementation environment; on 2026-07-15 the user explicitly accepted that documented runtime risk, approved Slice 5 as complete, and confirmed no further Slice 5 work is required. | 2026-07-15 |
| 6 — Integrated Hardening | Brainstorming | — | — | Brainstorming started 2026-07-15 in the current Codex session on branch `feat/annotation-integrated-hardening`. | 2026-07-15 |

...
| 3 — Box Tools | Spec approved | [`2026-07-14-box-tools-design.md`](2026-07-14-box-tools-design.md) (`1bdc539`) | — | User approved the complete Slice 3 design after review of the landed editor architecture and Rectangle/Ellipse UX in Snow Shot, Flameshot, mark-shot, and KDE Spectacle; implementation planning has not started. | 2026-07-14 |

...
| 4 — Freehand Tools | Spec approved | [`2026-07-14-freehand-tools-design.md`](2026-07-14-freehand-tools-design.md) (`3ab711f`) | — | Design approved interactively on 2026-07-14 (uniform per-stroke alpha Highlighter, distance filter + RDP simplification, per-segment hit testing, move-only editing, Pen/Highlighter defaults incl. first persisted sub-1.0 opacity). Spec committed on branch `feat/annotation-freehand-tools`; awaiting user review of the written spec before writing-plans. | 2026-07-14 |

...
| 5 — Pixelate Effect | Spec approved | [`2026-07-15-pixelate-effect-design.md`](2026-07-15-pixelate-effect-design.md) (`518064e`) | — | Design approved and committed on branch `feat/annotation-pixelate-effect`; awaiting user review of the written spec before implementation planning. Implementation has not begun. | 2026-07-15 |
